...
DELIMITER $$
USE `shoppingCart`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `createShoppingCart`(IN IN_quantity Integer, IN IN_proOffId VARCHAR(25), IN IN_customerId VARCHAR(25), OUT OUT_shoppingCartId VARCHAR(25),
