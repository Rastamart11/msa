...
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477d', 'Laptop MacBook Pro', 'Apple - MacBook Pro de 13', 'unico', 'mxm', 48999.90, './assets/images/reemplazo/c2.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477e', 'Laptop Gamer HP Pavilion ', 'HP Pavilion 15-ec0002la 15.6" Full HD', 'unico', 'mxm', 15999.90, './assets/images/reemplazo/c3.jpg');
...
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477h', 'Tablet Galaxy Tab S6', 'Samsung - Galaxy Tab S6 Lite 10.4', 'unico', 'mxm', 8990.90, './assets/images/reemplazo/c5.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477i', 'Tablet Galaxy Tab S7', 'Samsung - Galaxy Tab S7 de 11', 'unico', 'mxm', 16990.90, './assets/images/reemplazo/c6.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477j', 'Tablet Samsung - Galaxy Tab A8', 'Samsung - Galaxy Tab A8', 'unico', 'mxm', 8990.90, './assets/images/reemplazo/c7.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477k', 'Tablet Lenovo - Tab Slate', 'Lenovo - Tab Slate', 'unico', 'mxm', 3250.90, './assets/images/reemplazo/c8.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477l', 'Smartphone  Samsung - Galaxy', 'Samsung - Galaxy S20', 'unico', 'mxm', 3250.90, './assets/images/reemplazo/c9.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477m', 'Smartphone  Moto G9 Play', 'Motorola - Moto G9 Play - Azul - ATT', 'unico', 'mxm', 4999.90, './assets/images/reemplazo/c10.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477n', 'Smartphone Samsung Note', 'Samsung - Celular Note 20 Mystic 4G - Gris - ATT', 'unico', 'mxm', 25999.90, './assets/images/reemplazo/c11.jpg');
INSERT INTO productOffering (id, name, description, priceType, unitOfMeasure, value, urlImage) VALUE ('dsfds477o', 'Smartphone Samsung ', 'Samsung - Celular Note 20 Ultra 4G - Bronce - Telcel', 'unico', 'mxm', 33999.90, './assets/images/reemplazo/c12.jpg');
